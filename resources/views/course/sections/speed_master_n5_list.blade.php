    ...
    <section class="pt-24 pb-12 {{ $courseData['bgColor'] }}">
        <div class="container mx-auto max-w-7xl px-4 md:px-6">
            <div class="mb-8">
                ...
                <p class="text-center text-gray-600 text-base md:text-lg">Học nhanh và hiệu quả với giáo trình Speed Master N5</p>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto max-w-5xl px-4 md:px-6 lg:px-8">
            ...
            @if(empty($lessons))
                <div class="bg-gray-50 rounded-lg p-8 text-center">
                    <p class="text-gray-500">Chưa có bài Speed Master N5</p>
                </div>
            @endif
        </div>
    </section>
